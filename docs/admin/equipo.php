        ...
        <div class="card text-center ">
            ...
            <div class="card-body">
                <form action="../sql/agre_equipo-competicion.php" method="POST" class="my-5 mx-5 row g-3" enctype="multipart/form-data">
                    <div class="col-md-5 my-5">
                        <label for="imagen" class="form-label">
                            <figure class="d-inline-block mr-4">
                                ...
                                <figcaption class="text-center py-3 font-weight-medium text-black"><h5>Foto de Equipo</h5></figcaption>
                            </figure>
                        </label>
                    ...
                    <div class="col-md-5 my-5">
                        <label for="nombreEquipo" class="form-label">Nombre de la Equipo</label>
                        <input type="text" class="form-control text-black" placeholder="Nombre de la Equipo" 
                        id="nombreEquipo" name="nomEquipo">
                        <div class="valid-feedback">
                        Looks good!
                        </div>
                    </div>
                    <div class="col-12">
                        <button class="btn btn-primary" type="submit">Agregar Equipo</button>
                    </div>
                </form>
            </div>  
        </div>
